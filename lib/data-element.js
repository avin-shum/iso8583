...
var dataElement = {
  1   : ['b',   16,  FIXED_LENGTH],           //Bit Map Extended
	2   : ['an',  19,  VARIABLE_LENGTH, 2],        //Primary account number (PAN
  ...
  5   : ['n',   12,  FIXED_LENGTH],           //Amount reconciliation
	...
	32  : ['n',   11,  VARIABLE_LENGTH, 2],        //Acquiring institution identification code
	33  : ['n',   11,  VARIABLE_LENGTH, 2],        //Forwarding institution identification code
	34  : ['an',  28,  VARIABLE_LENGTH],        //Electronic commerce data
	35  : ['z',   37,  VARIABLE_LENGTH, 2],        //Track 2 data
	36  : ['n',   104, VARIABLE_LENGTH, 3],        //Track 3 data
	...
	44  : ['an',  25,  VARIABLE_LENGTH, 2],        //Additional response data
	45  : ['an',  79,  VARIABLE_LENGTH, 2],        //Track 1 data
	46  : ['an',  999, VARIABLE_LENGTH, 2],        //Amounts fees
	47  : ['an',  999, VARIABLE_LENGTH, 2],        //Additional data national
	48  : ['ans', 512, VARIABLE_LENGTH, 3],        //Additional data private
	...
	54  : ['an',  120, VARIABLE_LENGTH, 3],           //Amounts additional (Avin: default FIXED)
	55  : ['ans', 999, VARIABLE_LENGTH, 3],        //Integrated circuit card (ICC) system related data
	56  : ['ans', 500, FIXED_LENGTH],        //Original data elements (Avin: default VARIABLE)
	57  : ['ans', 999, VARIABLE_LENGTH, 3],        //Authorisation life cycle code
	58  : ['ans', 999, VARIABLE_LENGTH, 3],        //Authorising agent institution identification code
	59  : ['ans', 99,  VARIABLE_LENGTH, 4],        //Transport data
	60  : ['ans', 60,  VARIABLE_LENGTH, 3],        //Reserved for national use
	61  : ['ans', 99,  VARIABLE_LENGTH, 3],        //Reserved for national use
	62  : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for private use
	63  : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for private use
	...
	72  : ['ans', 4, FIXED_LENGTH],        //Data record (Avin: default VARIABLE)
	...
	99  : ['n',   11,  VARIABLE_LENGTH, 2],        //Settlement institution identification code
	100 : ['n',   11,  VARIABLE_LENGTH, 2],        //Receiving institution identification code
	101 : ['ans', 17,  FIXED_LENGTH],           //File name
	102 : ['ans', 28,  VARIABLE_LENGTH, 2],        //Account identification 1
	103 : ['ans', 28,  VARIABLE_LENGTH, 2],        //Account identification 2
	104 : ['an',  99,  VARIABLE_LENGTH, 3],        //Transaction description
	...
	110 : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for ISO use
	111 : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for private use
	112 : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for private use
	...
	116 : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for national use
	117 : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for national use
	...
	121 : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for private use
	122 : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for national use
	123 : ['ans', 999, VARIABLE_LENGTH, 3],        //Reserved for private use
	124 : ['ans', 255, VARIABLE_LENGTH, 3],        //Info Text
	125 : ['ans', 5120,  VARIABLE_LENGTH, 3],        //Network management information
	126 : ['ans', 60,   VARIABLE_LENGTH, 3],        //Issuer trace id
	127 : ['ans', 60, VARIABLE_LENGTH, 3],        //Reserved for private use
